...
private:
    ...
    void createSyncObjects()
    {
        ...
        if (vkCreateSemaphore(device, &semaphoreInfo, nullptr, &imageAvailableSemaphore) != VK_SUCCESS
            ...
            || vkCreateFence(device, &fenceInfo, nullptr, &inFightFence) != VK_SUCCESS) {
    ...
    void drawFrame()
    {
        vkWaitForFences(device, 1, &inFightFence, VK_TRUE, UINT64_MAX);
        vkResetFences(device, 1, &inFightFence);
        ...
        if (vkQueueSubmit(graphicQueue, 1, &submitInfo, inFightFence)) {
    ...
    void cleanup()
    {
        ...
        vkDestroyFence(device, inFightFence, nullptr);
